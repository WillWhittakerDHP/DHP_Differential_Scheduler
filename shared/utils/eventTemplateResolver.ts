/**
 * PATTERN: Shared template resolution for calendar event strings (client preview + server invites).
 * WHY: Keeps `{variable}` replacement identical in admin UI and production invite flow.
 */
