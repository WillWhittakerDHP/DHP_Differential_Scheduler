...
- Decisions made (with principles refs):
  ...
  - Event-shape rejected **`differentialRole`** API keys live in `server/src/routes/internal/entities/eventShapePayloadGuards.ts` with reject/strip on writes/responses (**§5.3**).
- Open questions:
