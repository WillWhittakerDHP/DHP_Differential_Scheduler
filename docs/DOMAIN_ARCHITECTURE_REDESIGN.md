...
> Warning: legacy redesign draft kept only for historical context during close-out.
> Do not use this file to make architecture decisions.
> The locked sources of truth are `ARCHITECTURE_PRINCIPLES.md` and `FEATURE_20_ARCHITECTURE_REDESIGN.md`.
> If this file conflicts with live close-out work, the locked documents win.
>
