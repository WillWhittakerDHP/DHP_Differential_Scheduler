...
### 2026-04-02 — 20.5 — phase — start — guide_materialization_failed
...
- **Symptom:** Harness start failed (reasonCode=guide_materialization_failed).
- **Context:** tier=phase; identifier=20.5; featureName=domain-architecture-alignment
...
### 2026-04-03 — 20.5 — phase — end — audit_failed
...
**Overall Status:** FAIL
**Report:** .cursor/project-manager/features/domain-architecture-alignment/audits/phase-20.5-audit.md

## External Signals (captured)

- **Location:** `.cursor/project-manager/features/domain-architecture-alignment/audits/external/phase-20.5/2026-04-03T01-10-55Z`
- **Copied:** 7 file(s)
- **Missing:** 2 file(s) (signals not present yet)
...
- ❌ **tier-quality**: fail (56/100)

## Autofix

Tier phase: 0 script fix(es) applied, 4 agent directive(s). Affected files: 3. Cascade: 1 lower-tier re-audit(s) run.
...
📄 **Report File:** `/Users/districthomepro/Bonsai/Differential_Scheduler/.cursor/project-manager/features/domain-architecture-alignment/audits/phase-20.5-audit.md`
...
Bonsai Differential Scheduler is a **Vue 3 + Express + Sequelize** application w
...
- **Location:** `.cursor/project-manager/features/domain-architecture-alignment/audits/external/phase-20.5/2026-04-03T01-14-17Z`
- **Copied:** 7 file(s)
- **Missing:** 2 file(s) (signals not present yet)
...
- **Location:** `.cursor/project-manager/features/domain-architecture-alignment/audits/external/phase-20.5/2026-04-03T01-16-06Z`
- **Copied:** 7 file(s)
- **Missing:** 2 file(s) (signals not present yet)
...
- **Public booking users** — wizard-style scheduling and property/availability flows.
- **Admin configurators** — domain-specific editors for shapes/instances, wizard settings, availability rules, integrations (target: **no** DB-driven admin metadata pipel
...
- **Location:** `.cursor/project-manager/features/domain-architecture-alignment/audits/external/phase-20.5/2026-04-03T01-17-53Z`
- **Copied:** 7 file(s)
- **Missing:** 2 file(s) (signals not present yet)
...
- **Location:** `.cursor/project-manager/features/domain-architecture-alignment/audits/external/phase-20.5/2026-04-03T01-19-43Z`
- **Copied:** 7 file(s)
- **Missing:** 2 file(s) (signals not present yet)
...
- **Location:** `.cursor/project-manager/features/domain-architecture-alignment/audits/external/phase-20.5/2026-04-03T01-22-27Z`
- **Copied:** 7 file(s)
- **Missing:** 2 file(s) (signals not present yet)
...
- **Location:** `.cursor/project-manager/features/domain-architecture-alignment/audits/external/phase-20.5/2026-04-03T01-25-17Z`
- **Copied:** 7 file(s)
- **Missing:** 2 file(s) (signals not present yet)
