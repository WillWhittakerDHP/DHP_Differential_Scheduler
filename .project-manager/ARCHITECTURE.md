...
**Purpose:** Canonical map of business domains, code boundaries, data flow, and type placement. Agents should read relevant sections before planning or decomposing work.
