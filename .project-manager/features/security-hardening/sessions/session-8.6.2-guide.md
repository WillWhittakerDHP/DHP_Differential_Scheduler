# Session 8.6.2 Guide: ** Client — wire token into API layer for mutating requests; smoke-test admin and booking flows that use CRUD
...
**Session ID:** 8.6.2
**Session Name:** ** Client — wire token into API layer for mutating requests; smoke-test admin and booking flows that use CRUD
...
**Recommended:** Use `/session-start 8.6.2 [description]` to automatically:
...
```
## Session: 8.6.2 - [Brief Description]
**Date:** [Date]
