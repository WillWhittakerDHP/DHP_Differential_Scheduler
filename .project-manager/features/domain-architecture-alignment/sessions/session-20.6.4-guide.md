# Session 20.6.4 Guide: Review gate, docs, and feature closeout
...
**Recommended:** Use `/session-start 20.6.4 [description]` to automatically:
...
```
## Session: 20.6.4 - [Brief Description]
**Date:** [Date]
