# Session 20.7.1 Guide: ** Canonical plan adoption and doc protections — align feature/handoff/phase surfaces; tombstone or warning on contradictory planning paths.
...
**Session ID:** 20.7.1
**Session Name:** ** Canonical plan adoption and doc protections — align feature/handoff/phase surfaces; tombstone or warning on contradictory planning paths.
...
**Recommended:** Use `/session-start 20.7.1 [description]` to automatically:
...
```
## Session: 20.7.1 - [Brief Description]
**Date:** [Date]
