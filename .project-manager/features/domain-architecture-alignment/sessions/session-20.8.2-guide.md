# Session 20.8.2 Guide: ** Event ownership and attendee ownership
...
**Session ID:** 20.8.2
**Session Name:** ** Event ownership and attendee ownership
...
**Recommended:** Use `/session-start 20.8.2 [description]` to automatically:
...
```
## Session: 20.8.2 - [Brief Description]
**Date:** [Date]
