# Session 20.8.1 Guide: ** Part-ledger contract residuals
...
**Session ID:** 20.8.1
**Session Name:** ** Part-ledger contract residuals
...
**Recommended:** Use `/session-start 20.8.1 [description]` to automatically:
...
```
## Session: 20.8.1 - [Brief Description]
**Date:** [Date]
