# Session 20.2.3 Guide: ** **Relationships + preview** — `eventAssignments`, `event_instance_attendees` / attendee relationship registry, `validEventCascades`; re-scope **`event-instance-preview`** to segments under a parent event block instance (or equivalent simplification per §5.1).
...
**Session ID:** 20.2.3
**Session Name:** ** **Relationships + preview** — `eventAssignments`, `event_instance_attendees` / attendee relationship registry, `validEventCascades`; re-scope **`event-instance-preview`** to segments under a parent event block instance (or equivalent simplification per §5.1).
...
**Recommended:** Use `/session-start 20.2.3 [description]` to automatically:
...
```
## Session: 20.2.3 - [Brief Description]
**Date:** [Date]
