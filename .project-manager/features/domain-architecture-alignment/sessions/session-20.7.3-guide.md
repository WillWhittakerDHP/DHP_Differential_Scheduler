# Session 20.7.3 Guide: Close-out backlog mapping
...
**Session ID:** 20.7.3
**Session Name:** Close-out backlog mapping
...
**Recommended:** Use `/session-start 20.7.3 [description]` to automatically:
...
```
## Session: 20.7.3 - [Brief Description]
**Date:** [Date]
