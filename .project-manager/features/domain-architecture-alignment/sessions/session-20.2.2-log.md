...
Paths (11): `.project-manager/features/domain-architecture-alignment/across-ladder.json`, `.project-manager/features/domain-architecture-alignment/sessions/session-20.2.2-guide.md`, `.project-manager/features/domain-architecture-alignment/sessions/session-20.2.2-log.md`, `client/tsconfig.tsbuildinfo`, `server/src/routes/internal/entities/entityBatchRouter.ts`, `server/src/routes/internal/entities/entityBulkRouter.ts`, `server/src/routes/internal/entities/entityCrudReadHandlers.ts`, `server/src/routes/internal/entities/entityCrudRouter.ts`, `.project-manager/features/domain-architecture-alignment/sessions/task-20.2.2.1-handoff.md`, `.project-manager/features/domain-architecture-alignment/sessions/task-20.2.2.1-planning.md`, `server/src/routes/internal/entities/eventShapeEntityValidation.ts`
...
.../across-ladder.json                             |  2 +-
 ...
 .../sessions/session-20.2.2-log.md                 | 18 +++++++++++
 client/tsconfig.tsbuildinfo                        |  1 -
 .../routes/internal/entities/entityBatchRouter.ts  |  9 +++++-
 .../routes/internal/entities/entityBulkRouter.ts   | 20 ++++++++++++
 .../internal/entities/entityCrudReadHandlers.ts    | 21 +++++++++++++
...
index b4d66639..6e578dc2 100644
...
-  "derivedAt": "2026-04-02T17:30:08.398Z",
+  "derivedAt": "2026-04-02T17:32:47.365Z",
   "sourceTier": "session",
   "phasesOnDisk": [
     "20.1",
...
index d867eeca..bf198001 100644
...
index d85aca58..433e988b 100644
