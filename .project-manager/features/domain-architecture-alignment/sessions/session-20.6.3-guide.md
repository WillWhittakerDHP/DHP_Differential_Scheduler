# Session 20.6.3 Guide: Legacy differential-role and event-shape remnants
...
**Session ID:** 20.6.3
**Session Name:** Legacy differential-role and event-shape remnants
...
- `FieldRenderer.vue` / `PrimitiveInputs.vue` / `codeFirstMetadataCache.ts` (if referenced)
...
**Recommended:** Use `/session-start 20.6.3 [description]` to automatically:
...
```
## Session: 20.6.3 - [Brief Description]
**Date:** [Date]
