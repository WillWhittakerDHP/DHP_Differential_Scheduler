# Session 20.4.1 Guide: Pipeline audit + safe dead-code (booking)
...
**Session ID:** 20.4.1
**Session Name:** Pipeline audit + safe dead-code (booking)
...
**Files:** `session-20.4.1-planning.md`, `session-20.4.1-log.md`, `client/src/utils/booking/*.ts`, `client/src/utils/transformers/globalToBookingTransformer.ts`, `shared/utils/eventPlacementUtils.ts`, `shared/utils/differentialRoleUtils.ts`
...
**Checkpoint:** Lint clean; behavior unchanged (empty overrides).
...
**Recommended:** Use `/session-start 20.4.1 [description]` to automatically:
...
```
## Session: 20.4.1 - [Brief Description]
**Date:** [Date]
