# Session 20.3.5 Guide: — Annotation metadata + EntityCard wave (§8.3 #5):** Narrow non-annotation metadata scope where plan allows; replace lowest-risk **EntityCard** usage with focused component(s); document remaining EntityCard debt for **20.6**.
...
**Session ID:** 20.3.5
**Session Name:** — Annotation metadata + EntityCard wave (§8.3 #5):** Narrow non-annotation metadata scope where plan allows; replace lowest-risk **EntityCard** usage with focused component(s); document remaining EntityCard debt for **20.6**.
...
**Recommended:** Use `/session-start 20.3.5 [description]` to automatically:
...
```
## Session: 20.3.5 - [Brief Description]
**Date:** [Date]
