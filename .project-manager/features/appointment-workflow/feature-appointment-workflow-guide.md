...
**Success Criteria:**
- [ ] Margin role + **`PartFinal.minimizer === 'override'`** when margin applies
- [ ] Multiple minimizer segments chain boundaries correctly
- [ ] Calendar / API / confirmation behavior documented or implemented per inventory
