# Session 6.7.2 Guide: ** Admin UI — display scheduled_by in appointment details
...
**Session ID:** 6.7.2
**Session Name:** ** Admin UI — display scheduled_by in appointment details
...
**Recommended:** Use `/session-start 6.7.2 [description]` to automatically:
...
```
## Session: 6.7.2 - [Brief Description]
**Date:** [Date]
