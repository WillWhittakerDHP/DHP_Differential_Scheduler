# Session 6.17.5 Guide: Entity-policy rollout + documentation
...
**Session ID:** 6.17.5
**Session Name:** Entity-policy rollout + documentation
...
**Recommended:** Use `/session-start 6.17.5 [description]` to automatically:
...
```
## Session: 6.17.5 - [Brief Description]
**Date:** [Date]
