# Session 6.18.2 Guide: Admin alignment — canonical roles ↔ user-type block instances
...
**Session ID:** 6.18.2
**Session Name:** Admin alignment — canonical roles ↔ user-type block instances
...
- [x] #### Task 6.18.2.2: Admin UI — role ↔ user-type instance matrix
...
**Recommended:** Use `/session-start 6.18.2 [description]` to automatically:
...
```
## Session: 6.18.2 - [Brief Description]
**Date:** [Date]
