# Session 6.17.3 Guide: Reusable client delete wizard + composable/service
...
**Session ID:** 6.17.3
**Session Name:** Reusable client delete wizard + composable/service
...
**Recommended:** Use `/session-start 6.17.3 [description]` to automatically:
...
```
## Session: 6.17.3 - [Brief Description]
**Date:** [Date]
