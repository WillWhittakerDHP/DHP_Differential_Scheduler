...
**Goal:** Update Force Schedule and Override visibility logic to respect (user role, block.agentPermissions). Admin always allowed; agent when `'true'` or `'override'`; client when `'false'` or `'override'`.
