...
- Session Guide: `.project-manager/features/appointment-workflow/sessions/session-6.10.4-guide.md` (detailed instructions and patterns)
- Session Log: `.project-manager/features/appointment-workflow/sessions/session-6.10.4-log.md`
- Phase Handoff: `.project-manager/features/appointment-workflow/phases/phase-6.10-handoff.md` (for phase-level context)