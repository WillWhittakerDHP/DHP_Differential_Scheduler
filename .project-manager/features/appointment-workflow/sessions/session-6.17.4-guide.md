# Session 6.17.4 Guide: Wire generic delete entry points (list + entity card)
...
**Session ID:** 6.17.4
**Session Name:** Wire generic delete entry points (list + entity card)
...
**Recommended:** Use `/session-start 6.17.4 [description]` to automatically:
...
```
## Session: 6.17.4 - [Brief Description]
**Date:** [Date]
