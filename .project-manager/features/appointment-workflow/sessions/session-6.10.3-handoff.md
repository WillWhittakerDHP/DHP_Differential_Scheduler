...
- Session Guide: `.project-manager/features/appointment-workflow/sessions/session-6.10.3-guide.md` (detailed instructions and patterns)
- Session Log: `.project-manager/features/appointment-workflow/sessions/session-6.10.3-log.md`
- Phase Handoff: `.project-manager/features/appointment-workflow/phases/phase-6-handoff.md` (for phase-level context)
