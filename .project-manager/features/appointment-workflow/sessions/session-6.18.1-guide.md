# Session 6.18.1 Guide: Shared role catalog + `seller` → `owner` + full-stack audit
...
**Session ID:** 6.18.1
**Session Name:** Shared role catalog + `seller` → `owner` + full-stack audit
...
**Recommended:** Use `/session-start 6.18.1 [description]` to automatically:
...
```
## Session: 6.18.1 - [Brief Description]
**Date:** [Date]
