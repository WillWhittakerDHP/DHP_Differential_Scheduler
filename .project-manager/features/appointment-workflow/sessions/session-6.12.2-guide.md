# Session 6.12.2 Guide: ** Annotation UI slots registry and wizard pipeline
...
**Recommended:** Use `/session-start 6.12.2 [description]` to automatically:
...
```
## Session: 6.12.2 - [Brief Description]
**Date:** [Date]
