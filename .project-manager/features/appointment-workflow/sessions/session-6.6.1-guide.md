# Session 6.6.1 Guide: ** Soft delete vs hard delete — policy, UI, retention/audit (to be refined in session planning)
...
**Session ID:** 6.6.1
**Session Name:** ** Soft delete vs hard delete — policy, UI, retention/audit (to be refined in session planning)
...
**Recommended:** Use `/session-start 6.6.1 [description]` to automatically:
...
```
## Session: 6.6.1 - [Brief Description]
**Date:** [Date]
