# Session 6.13.1 Handoff: Session 6.13.1
...
- Session Guide: `.project-manager/features/appointment-workflow/sessions/session-6.13.1-guide.md` (detailed instructions and patterns)
- Session Log: `.project-manager/features/appointment-workflow/sessions/session-6.13.1-log.md`
- Phase Handoff: `.project-manager/features/appointment-workflow/phases/phase-6.13-handoff.md` (for phase-level context)