# Session 6.5.1 Guide: Guide: Rescheduling Flow
...
**Session ID:** 6.5.1
**Session Name:** Guide: Rescheduling Flow
...
**Recommended:** Use `/session-start 6.5.1 [description]` to automatically:
...
```
## Session: 6.5.1 - [Brief Description]
**Date:** [Date]
