# Session 6.17.2 Guide: Server preflight / resolution / finalize infrastructure
...
**Session ID:** 6.17.2
**Session Name:** Server preflight / resolution / finalize infrastructure
...
**Recommended:** Use `/session-start 6.17.2 [description]` to automatically:
...
```
## Session: 6.17.2 - [Brief Description]
**Date:** [Date]
