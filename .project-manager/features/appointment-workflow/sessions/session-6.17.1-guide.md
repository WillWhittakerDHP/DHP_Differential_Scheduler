# Session 6.17.1 Guide: Delete dependency model + API contract
...
**Session ID:** 6.17.1
**Session Name:** Delete dependency model + API contract
...
**Recommended:** Use `/session-start 6.17.1 [description]` to automatically:
...
```
## Session: 6.17.1 - [Brief Description]
**Date:** [Date]
