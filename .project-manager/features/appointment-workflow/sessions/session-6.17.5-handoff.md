# Session 6.17.5 Handoff: Session 6.17.5
...
- **Feature:** `appointment-workflow` · **Source:** session_end · **Derived:** 2026-04-01T23:23:06.800Z
...
- Session Guide: `.project-manager/features/appointment-workflow/sessions/session-6.17.5-guide.md` (detailed instructions and patterns; use your feature’s directory if not Feature 6)
- Session Log: `.project-manager/features/appointment-workflow/sessions/session-6.17.5-log.md`
