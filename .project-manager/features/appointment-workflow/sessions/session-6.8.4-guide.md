# Session 6.8.4 Guide: ** Reschedule flow and override records — pass allowedExceptions, distinct slot indicator, new override on reschedule
...
**Session ID:** 6.8.4
**Session Name:** ** Reschedule flow and override records — pass allowedExceptions, distinct slot indicator, new override on reschedule
...
**Recommended:** Use `/session-start 6.8.4 [description]` to automatically:
...
```
## Session: 6.8.4 - [Brief Description]
**Date:** [Date]
