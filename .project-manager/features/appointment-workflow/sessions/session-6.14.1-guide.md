# Session 6.14.1 Guide: ** Organization defaults & resolved numeric policy (availability + calendar)
...
**Session ID:** 6.14.1
**Session Name:** ** Organization defaults & resolved numeric policy (availability + calendar)
...
**Recommended:** Use `/session-start 6.14.1 [description]` to automatically:
...
```
## Session: 6.14.1 - [Brief Description]
**Date:** [Date]
