...
- Session Guide: `.project-manager/features/appointment-workflow/sessions/session-6.13.2-guide.md` (detailed instructions and patterns)
- Session Log: `.project-manager/features/appointment-workflow/sessions/session-6.13.2-log.md`
