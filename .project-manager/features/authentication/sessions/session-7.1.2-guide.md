# Session 7.1.2 Guide: ** Sequelize models, fields, and associations for auth tables
...
**Session ID:** 7.1.2
**Session Name:** ** Sequelize models, fields, and associations for auth tables
