# Session 7.1.1 Guide: ** Migrations for `sessions` and `magic_links` tables
...
**Session ID:** 7.1.1
**Session Name:** ** Migrations for `sessions` and `magic_links` tables
