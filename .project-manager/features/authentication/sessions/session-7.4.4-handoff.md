# Session 7.4.4 Handoff: Session 7.4.4
...
- Session Guide: `.cursor/project-manager/features/vue-migration/sessions/session-7.4.4-guide.md` (detailed instructions and patterns)
- Session Log: `.cursor/project-manager/features/vue-migration/sessions/session-7.4.4-log.md`
- Phase Handoff: `.cursor/project-manager/features/vue-migration/phases/phase-7.4-handoff.md` (for phase-level context)