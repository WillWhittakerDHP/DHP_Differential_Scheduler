...
import { preprocessBusyPeriods } from '../busyPeriodProcessor'
import { checkSlotAvailability } from '../overlapConstraintChecker'
import { checkRangeConstraints } from '../rangeConstraintChecker'
import { shouldApplyDriveTimeConstraint } from '../overlapConstraintChecker'
import { DEFAULT_INCLUDE_FLAGS, type BusinessHoursMap } from '../slotPipeline'
...
describe('orchestrateSlotAvailability with preprocessed busy periods', () => {
  it('should correctly mark slots unavailable with merged busy periods', () => {
    ...
    const result = orchestrateSlotAvailability({
...
describe('orchestrateSlotAvailability - capacity batching', () => {
  it('should batch capacity checks for slots on same date', async () => {
    ...
    const result = await orchestrateSlotAvailability({
