...
// Phase 8: Removed FreeBusyDataSource import - data source now controlled server-side
// Note: FreeBusyDataSource type may still be referenced elsewhere, but this file no longer needs it
...
// Phase 9: Removed getCalendarAvailability, getRealBusyTimes, getMockBusyTimes, mergeOverlappingBusyTimes, getMockBusyTimesSync
// WHY: Busy times are now fetched server-side via the orchestrator
// These functions are no longer needed - all calendar availability comes from ComputedAvailabilityData
