...
export interface LayoutConfig {
  ...
  icons: {
    chevronDown: Component | string
    chevronRight: Component | string
    close: Component | string
    verticalNavPinned: Component | string
    verticalNavUnPinned: Component | string
    sectionTitlePlaceholder: Component | string
  }
}
