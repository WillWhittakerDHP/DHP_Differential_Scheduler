...
import HorizontalNavPopper from '@layouts/components/HorizontalNavPopper.vue'
...
<template>
  ...
  >
    <div class="nav-group-label">
      ...
      <Component
        v-bind="
          typeof layoutConfig.icons.chevronDown === 'object' && layoutConfig.icons.chevronDown !== null
