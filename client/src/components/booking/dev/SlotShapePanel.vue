  ...
  <div class="pa-3">
    <div v-if="appointmentShape" class="mb-4">
      ...
      <VRow density="comfortable" class="ma-0 mb-2">
        ...
        <VCol cols="6">
          <VCard variant="outlined" density="compact" class="pa-2">
            <div class="text-body-small text-medium-emphasis font-weight-bold mb-1">Differential Offset</div>
            <div class="text-body-medium mb-1">
      ...
      <VRow v-if="slotShapeTotals.eventFinals.length > 0" density="comfortable" class="ma-0">
        ...
        >
          <VCard variant="outlined" density="compact" class="pa-2">
            <div class="text-body-small text-medium-emphasis">{{ eventFinal.eventShape.name }}</div>
