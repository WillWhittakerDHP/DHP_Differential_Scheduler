<!--
  WHY: Shared part-instance ledger table for block instances (service, time, price, etc.).
  PATTERN: VCard + VDataTable; useAtomicPartLedgerRows + useEntityCrud('partInstance').update.
-->
