...
import { createComputedAvailabilityMutableState } from '@/composables/booking/useComputedAvailabilityState'
...
export function useComputedAvailability(
  ...
  const state = createComputedAvailabilityMutableState()
