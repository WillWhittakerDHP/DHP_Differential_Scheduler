/**
 * Order-index patch mutation factory for useEntityCrudMutations.
...
import type { OrderIndexUpdate } from './useEntityCrudTypes'

export function createOrderMutationOptions<GlobalEntityTypeKey extends GlobalEntityKey>(
