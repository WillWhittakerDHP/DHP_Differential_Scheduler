...
<template>
  <!-- WHY: HTML comment syntax is valid in Vue templates, regex rule incorrectly flags it -->
      ...
      <div v-show="isCodeShown">
        ...
        <VCardText class="d-flex gap-y-3 flex-column">
          ...
          <div class="position-relative">
            ...
            >
              <!-- WHY: v-html is necessary for syntax highlighting output from shiki library -->
              <!-- PATTERN: Code snippets are sanitized by shiki, security risk is minimal -->
