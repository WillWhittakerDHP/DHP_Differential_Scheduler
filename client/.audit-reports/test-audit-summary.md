...
| `client/src/composables/booking/useAvailabilityLogic.ts` | 7.9 | 7.9 | 10 | 8 | 3 |
| `client/src/utils/transformers/componentAggregator.ts` | 7.8 | 7.8 | 10 | 10 | 2 |
| `client/src/composables/booking/useAppointmentDataCollection.ts` | 7.7 | 7.7 | 9 | 7 | 2 |
...
| `client/src/composables/booking/useWizardValidationErrors.ts` | 7.7 | 7.7 | 9 | 7 | 2 |
