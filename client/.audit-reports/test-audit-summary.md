...
| `client/src/composables/booking/useAvailabilityStepHandlers.ts` | P0 | 7.7 | 10 | 7 | 2 |
...
| `client/src/composables/booking/useAvailabilityDevPanel.ts` | P0 | 7.6 | 9 | 8 | 4 |
| `client/src/composables/booking/useDevPanelsComputed.ts` | P0 | 7.5 | 10 | 7 | 2 |
| `client/src/utils/booking/partFinalizer.ts` | P0 | 7.5 | 9 | 9 | 4 |
| `client/src/utils/booking/partShapeAggregator.ts` | P0 | 7.4 | 7 | 10 | 5 |
| `client/src/composables/booking/useBusyTimes.ts` | P0 | 7.3 | 9 | 7 | 2 |
| `client/src/composables/booking/useDurationRounding.ts` | P0 | 7.3 | 9 | 7 | 2 |
| `client/src/composables/booking/useMockCalendarRefresh.ts` | P0 | 7.3 | 9 | 7 | 2 |
| `client/src/composables/booking/useTimeSlotDurations.ts` | P0 | 7.3 | 9 | 7 | 2 |
| `client/src/composables/booking/useWizardStepDataRefs.ts` | P0 | 7.3 | 9 | 7 | 2 |
...
| `client/src/composables/booking/useAppointmentSlots.ts` | P0 | 7.1 | 10 | 7 | 2 |
| `client/src/composables/booking/useAvailableStartTimes.ts` | P0 | 7.1 | 10 | 7 | 2 |
| `client/src/composables/booking/dev/usePanelPosition.ts` | P0 | 7.0 | 9 | 7 | 2 |
