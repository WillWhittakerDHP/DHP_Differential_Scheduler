...
| `src/composables/admin/tables/useAppointmentHelpers.ts` | **6.3** | 7 | 5 | 2 |
| `src/composables/admin/useInstanceFiltering.ts` | **6.3** | 8 | 5 | 2 |
| `src/composables/admin/useSelectFiltering.ts` | **6.3** | 8 | 5 | 2 |
| `src/composables/admin/useSelectHandlers.ts` | **6.2** | 7 | 5 | 2 |
| `src/composables/admin/useAvailabilitySettings.ts` | **6.1** | 9 | 5 | 2 |
...
| `src/composables/admin/useInstanceSaveHandlers.ts` | **5.5** | 5 | 5 | 2 |
