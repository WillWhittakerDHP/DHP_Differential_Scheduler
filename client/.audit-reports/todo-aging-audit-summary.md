...
- Total markers: **30**
- Ancient (> 180d): **29** | Stale (90-180d): **0** | Aging (30-90d): 0 | Fresh (< 30d): 1
- Orphaned (no ticket): **30**
...
| `client/src/views/admin/tabs/components/AppointmentsTable.vue` | P1 | 14 | 2 | 2 | 0 | 2 |
