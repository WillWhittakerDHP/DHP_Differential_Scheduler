...
| `client/src/composables/booking/useAppointmentDataCollection.ts` | P0 | 21 | 0 | 0 | 0 | 0 | 0 | 0 | 0 |
...
| `client/src/components/admin/generic/EntityCard.vue` | P1 | 12 | 0 | 0 | 0 | 0 | 0 | 0 | 0 |
...
| `client/src/views/admin/tabs/InstancesTab.vue` | P1 | 12 | 0 | 0 | 0 | 0 | 0 | 0 | 0 |
| `server/src/routes/internal/property-mappings/propertyMappingsRouter.ts` | P1 | 12 | 0 | 0 | 0 | 0 | 0 | 0 | 0 |
...
| `client/src/components/booking/steps/PropertyDetailsStep.vue` | P1 | 10 | 0 | 0 | 0 | 0 | 0 | 0 | 0 |
