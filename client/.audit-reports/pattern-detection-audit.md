...
| --- | ---: | --- |
| `held` | 7 | `client/src/composables/useAppointment.ts:80`, `client/src/types/appointmentApi.ts:61`, `client/src/types/appointmentApi.ts:101` (+4 more) |
| `confirmed` | 6 | `client/src/composables/admin/tables/useAppointmentsTableModel.ts:84`, `client/src/composables/admin/useInstancesTabEventInstance.ts:82`, `client/src/types/admin/instancesTabEventInstance.ts:26` (+3 more) |
| `started` | 3 | `client/src/composables/admin/tables/useAppointmentsTableModel.ts:109`, `client/src/composables/useAppointment.ts:84`, `server/src/db/models/booking/appointment.ts:49` |
