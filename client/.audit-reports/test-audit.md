...
Generated at: 2026-03-22T13:21:26.009Z

## Summary

- **Total source files**: 1169
- **Total test files**: 0
- **Untested source files**: 1169
...
| `client/src/composables/booking/useAvailabilityStepFeePreview.ts` | **7.7** | 10 | 7 | 8 | 0 | 2 |
...
| `client/src/utils/booking/confirmationStepData.ts` | **7.1** | 6 | 9 | 9 | 2 | 3 |
...
| `client/src/composables/booking/useAvailabilityStepAccordion.ts` | **6.9** | 9 | 7 | 6 | 0 | 2 |
...
| `server/src/repositories` | 1 | 0 | 1 | 0% |
| `server/src/routes` | 1 | 0 | 1 | 0% |
| `server/src/routes/internal/auth` | 1 | 0 | 1 | 0% |
