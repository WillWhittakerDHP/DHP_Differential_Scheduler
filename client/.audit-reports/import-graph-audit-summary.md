...
| `client/src/types/entities` | P2 | 2 |
...
| `client/src/types/appointment` | P2 | 2 |
...
| `server/src/routes/internal/entities/entityConstants` | P2 | 2 |
| `client/src/utils/api` | P2 | 2 |
| `server/src/constants/router` | P2 | 2 |
| `server/src/config/app` | P2 | 2 |
| `client/src/composables/useAdmin` | P2 | 2 |
| `client/src/utils/transformers/fetchToGlobalTransformer` | P2 | 2 |
