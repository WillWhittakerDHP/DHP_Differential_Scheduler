...
- Generated at: **2026-03-04T18:41:56.104Z**
...
| --- | --- | ---: | ---: | ---: | ---: | ---: |
| P2 | `TS6133-ts6133-useroute-is-declared-but-its-value-is-never-read` | 6 | 1 | 1 | 0 | 0 |
...
```
TS6133@6:1 'useRoute' is declared but its value is never read.
```
