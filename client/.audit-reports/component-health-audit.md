...
Generated: 2026-02-26T00:03:41.707Z
...
| complex-template-expression | P2 | 1 |
| component-coupling | P1 | 1 |

## Repair Waves

- **Wave 1 — Local** (parentCount = 0): 0 finding(s)
- **Wave 2 — Low fan-in** (parentCount 1–3): 7 finding(s)
...
| `client/src/views/admin/tabs/components/AppointmentsTable.vue` | 79 | oversized-template | Template is 251 lines; extract sub-components to improve ... | 1 |
...
| `client/src/views/admin/tabs/components/PropertiesTable.vue` | 47 | oversized-template | Template is 282 lines; extract sub-components to improve ... | 1 |
| `client/src/views/admin/tabs/components/UsersTable.vue` | 42 | oversized-template | Template is 209 lines; extract sub-components to improve ... | 1 |
