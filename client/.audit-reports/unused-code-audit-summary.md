...
| --- | --- | ---: | ---: | ---: | ---: | ---: |
| `client/src/utils/api.ts` | P0 | 20 | 5 | 1 | 3 | 0 |
| `client/src/utils/optimistic/annotationAssignmentsOptimistic.ts` | P0 | 19 | 6 | 0 | 1 | 0 |
...
| `client/src/utils/transformers/annotationTransformers.ts` | P0 | 12 | 4 | 0 | 0 | 0 |
| `server/src/config/entityRegistry.ts` | P0 | 12 | 4 | 0 | 0 | 0 |
| `server/src/test/setup/seedTestData.ts` | P0 | 12 | 4 | 0 | 0 | 0 |
| `client/src/utils/annotationUtils.ts` | P0 | 10 | 2 | 0 | 4 | 0 |
...
| `client/src/utils/booking/timeSlotMatching.ts` | P1 | 7 | 2 | 0 | 1 | 0 |
