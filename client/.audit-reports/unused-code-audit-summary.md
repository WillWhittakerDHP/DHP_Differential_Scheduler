...
| `client/src/composables/useLocalTime.ts` | P0 | 11 | 3 | 0 | 2 | 0 |
...
| `client/src/composables/booking/useStepValidation.ts` | P1 | 9 | 3 | 0 | 0 | 0 |
...
| `client/src/composables/dev/useApiDevPanelData.ts` | P1 | 7 | 1 | 0 | 4 | 0 |
...
| `client/src/composables/admin/useFieldKeyboardGuard.ts` | P1 | 6 | 2 | 0 | 0 | 0 |
...
| `client/src/composables/booking/useAppointmentShape.ts` | P1 | 6 | 2 | 0 | 0 | 0 |
...
| `client/src/composables/admin/useFieldInputSetup.ts` | P2 | 3 | 1 | 0 | 0 | 0 |
...
| `client/src/composables/admin/utils/nestedComputedFactory.ts` | P2 | 3 | 1 | 0 | 0 | 0 |
| `client/src/composables/booking/useAvailabilityDevPanel.ts` | P2 | 3 | 1 | 0 | 0 | 0 |
| `client/src/composables/booking/useAvailabilityLogic.ts` | P2 | 3 | 1 | 0 | 0 | 0 |
| `client/src/composables/booking/useAvailabilityOrchestrator.ts` | P2 | 3 | 1 | 0 | 0 | 0 |
...
| `client/src/composables/useAvailability.ts` | P2 | 3 | 1 | 0 | 0 | 0 |
...
| `client/src/views/admin/tabs/BusinessRulesTab.vue` | P2 | 3 | 0 | 0 | 3 | 0 |
...
| `client/src/views/admin/tabs/components/AppointmentsTable.vue` | P2 | 2 | 0 | 0 | 2 | 0 |
...
| `client/src/components/booking/steps/AvailabilityStep.vue` | P2 | 1 | 0 | 0 | 1 | 0 |
