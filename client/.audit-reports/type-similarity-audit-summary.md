...
- Files scanned: **623**
- Type definitions: **687**
- Similarity groups: **102**

| Action | Count | Meaning |
| --- | ---: | --- |
| UNIFY | 42 | Same concept duplicated — consolidate |
| BRAND | 15 | Different concept, same shape — add branding |
...
| --- | --- | --- | --- | ---: | ---: |
| P0 | EXTEND | SUBSET | `DayHours`, `ServerFreeBusyResponse`, `CalendarEvent`, `BusyTimeRange`, `CachedCalendarEvent`, `FreeBusyResponse`, `CreatedEventResponse`, `BusyTimeRange`, `CalendarEvent`, `ComputedAvailabilityRequest`, `DateRangeConfig`, `GoogleCalendarBusyPeriod`, `DayBusinessHours`, `DateRangeConfig`, `DayHours`, `DateRangeConfig` | 8 | 65 |
...
| P0 | EXTEND | SUBSET | `ContactInfo`, `UserResponse`, `UserRequest`, `UserResponse`, `WizardStateData`, `ParsedClient`, `AppointmentWithDetails`, `PropertyFormData`, `PropertyDetails`, `PropertyDetailsData`, `PropertyDetailsStepData`, `PropertyResponse`, `PropertyRequest`, `PropertyResponse`, `ParsedProperty` | 11 | 59 |
| P0 | REVIEW | EXACT | `DayHours`, `DateRangeConfig`, `GoogleCalendarBusyPeriod`, `DayBusinessHours`, `DateRangeConfig`, `DayHours`, `DateRangeConfig` | 5 | 33 |
...
| P0 | UNIFY | EXACT | `RangeConstraint`, `RangeConstraint`, `RangeConstraint` | 3 | 21 |
...
| P0 | BRAND | EXACT | `ServerFreeBusyResponse`, `FreeBusyResponse` | 2 | 15 |
...
| P0 | EXTEND | SUBSET | `UseAppointmentDropdownOptions`, `UseWizardDevModeOptions`, `UseAppointmentDropdownReturn` | 2 | 14 |
...
| P0 | REVIEW | HIGH_OVERLAP | `AttendeeRequest`, `AttendeeRequest` | 2 | 12 |
| P0 | EXTEND | SUBSET | `SlotGenerationParams`, `GenerateSlotsWithAvailabilityParams`, `FitTimeSlotsParams` | 3 | 12 |
...
| P1 | UNIFY | EXACT | `RetryConfig`, `RetryConfig` | 2 | 10 |
| P1 | UNIFY | EXACT | `LoadingIndicatorInstance`, `LoadingIndicatorInstance` | 2 | 10 |
| P1 | BRAND | EXACT | `AvailabilityManagerResult`, `FitTimeSlotsResult`, `FitTimeSlotsResultWithAvailability` | 2 | 10 |
...
| P1 | EXTEND | SUBSET | `FreeBusyResponseWithMeta`, `CalendarEventsResponseWithMeta` | 1 | 10 |
...
| P2 | REVIEW | HIGH_OVERLAP | `CalendarEvent`, `CalendarEvent` | 2 | 5 |
