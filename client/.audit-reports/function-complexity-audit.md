...
| --- | --- | ---: | ---: | ---: | ---: |
| `client/src/composables/admin/tables/useAppointmentsTableModel.ts` | P1 | 5 | 1 | 3 | 122 |

## Per-file details

### `client/src/composables/admin/tables/useAppointmentsTableModel.ts` [P1]

- **useAppointmentsTableModel** (L35-156, 122 lines): branches=12>8, length=122>50, returns=16>4
