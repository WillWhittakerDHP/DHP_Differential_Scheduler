...
| --- | --- | ---: | ---: | ---: | ---: |
| `client/src/composables/booking/useAvailabilityOrchestrator.ts` | P1 | 5 | 1 | 3 | 320 |

## Per-file details

### `client/src/composables/booking/useAvailabilityOrchestrator.ts` [P1]

- **useAvailabilityOrchestrator** (L28-347, 320 lines): branches=17>8, length=320>50, returns=15>4
