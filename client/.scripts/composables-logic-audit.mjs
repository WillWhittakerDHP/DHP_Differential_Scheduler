 ...
 *
 * Exception Handling:
 * - Config: .audit-reports/composables-logic-audit-config.json (allowlist patterns/specific)
 *
 * Output:
 * - client/.audit-reports/composables-logic-audit.json
 * - client/.audit-reports/composables-logic-audit.md
 *
 * Notes:
