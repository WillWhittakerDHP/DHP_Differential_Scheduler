 ...
 *
 * Exception Handling:
 * - Config: .audit-reports/component-logic-audit-config.json (allowlist patterns/specific)
 *
 * Output:
 * - client/.audit-reports/component-logic-audit.json
 * - client/.audit-reports/component-logic-audit.md
 *
 * Notes:
