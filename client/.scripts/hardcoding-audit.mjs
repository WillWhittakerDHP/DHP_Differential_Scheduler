 ...
 *
 * Output:
 * - client/.audit-reports/hardcoding-audit.json
 * - client/.audit-reports/hardcoding-audit.md
 *
 * Exception Handling:
 * - Inline: // @audit-allow:hardcoding:<ruleId> - <reason>
 * - Config: .audit-reports/hardcoding-audit-config.json (allowlist patterns/specific)
 *
 * Notes:
...
function renderMarkdownReport(data) {
  ...
  lines.push('- Config: `.audit-reports/hardcoding-audit-config.json`')
  lines.push('')
