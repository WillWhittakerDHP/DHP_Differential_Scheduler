 ...
 * Date: 2026-03-22
 * Source: pg_dump --schema-only / --data-only against scheduler_db (PostgreSQL 18.3)
 *
...
export default {
  async up(queryInterface, _Sequelize) {
    const schemaPath = join(__dirname, '20260322_000001_baseline_schema.sql');
    const dataPath = join(__dirname, '20260322_000001_baseline_data.sql');
