...
const wizardSettingsDataSchema = Joi.object({
  ...
  minimizerFallbackLabel: optionalLabelString,
  ...
  subStepLabelConfirmMinimizer: optionalLabelString,
  minimizerNoFeasibleCompletionSlotsMessage: optionalLabelString,
