...
export const createDwellingAdjustment = async (req: Request, res: Response) => {
  const { dwelling_adjustment_id, title, appointment_part_1, appointment_part_2, appointment_part_3, appointment_part_4 } = req.body;
  try {
    const newDwellingAdjustment = await DwellingAdjustment.create({ dwelling_adjustment_id, title, appointment_part_1, appointment_part_2, appointment_part_3, appointment_part_4 });
...
export const updateDwellingAdjustment = async (req: Request, res: Response) => {
  ...
  try {
    ...
    if (updatedDwellingAdjustment) {
      ...
      updatedDwellingAdjustment.title = title;
