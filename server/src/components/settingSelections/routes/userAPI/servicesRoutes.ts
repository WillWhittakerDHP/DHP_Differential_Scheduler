...
export const createService = async (req: Request, res: Response) => {
  const { service_id, title, can_be_scheduled, differential_scheduling, ui_description_set, appointment_part_1, appointment_part_2, appointment_part_3, appointment_part_4 } = req.body;
  try {
    const newService = await Service.create({ service_id, title, can_be_scheduled, differential_scheduling, ui_description_set, appointment_part_1, appointment_part_2, appointment_part_3, appointment_part_4 });
...
export const updateService = async (req: Request, res: Response) => {
  ...
  try {
    ...
    if (updatedService) {
      ...
      updatedService.ui_description_set = ui_description_set;
